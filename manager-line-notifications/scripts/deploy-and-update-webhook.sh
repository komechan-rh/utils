...
#   - CLASP_USER を環境変数で設定していること
#   - LINE_CHANNEL_ACCESS_TOKEN は Infisical の /manager-line-notifications から
#     `infisical run` 経由で注入されること（package.json の deploy:webhook 参照）
set -euo pipefail
